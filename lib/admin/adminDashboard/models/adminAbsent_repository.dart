...
import 'adminAbsentEmployee_model.dart';


class AbsentEmployeeRepository {
  final String baseUrl;

  AbsentEmployeeRepository(this.baseUrl);

  Future<List<AdminAbsentEmployee>> getPresentEmployees(DateTime date) async {
    ...
    if (formattedDate != null) {
      ...
      if (adminData.isNotEmpty) {
        ...
        final url = Uri.parse('$baseUrl/GetAbsentEmployees?CorporateId=$corporateId&Date=$formattedDate');
